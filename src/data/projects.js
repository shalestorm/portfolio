const projects = [
    {
        id: 1,
        title: 'PokeDex companion app',
        description: 'Web based Pokedex built in React, utilizing the external Pokemon API ',
    ...
    {
        id: 2,
        title: 'One Piece TCG Stat Tracker',
        description: 'A webapp to log matches and keep track of stats for the One piece TCG',
